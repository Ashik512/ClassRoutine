<?php 
 ...
 if($_SERVER['REQUEST_METHOD'] == 'GET')
 {
  ...
  {
    echo json_encode(array('response' =>'Time should not be same...', 'message' => 'Times are same...'));
  }
  ...
  else
  {
	...
	finish_time, day_select,dept,year) VALUES ('$subject','$teacher','$room_no', '$start_time', 
