...
public class RoutineDesignActivity extends AppCompatActivity {
    ...
    private TextView Start_Time,text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (iddata != null) {
            ...
            /*Toast.makeText(RoutineDesignActivity.this,
                    iddata,Toast.LENGTH_SHORT).show();*/
            ...
            String day = data.getStringExtra("day_select");
            text.setText("Update Class Routine");
        ...
        DeleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // Toast.makeText(RoutineDesignActivity.this, iddata, Toast.LENGTH_SHORT).show();
        ...
        UpdateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /*Toast.makeText(RoutineDesignActivity.this,
                        iddata+subject+teacher+room_no+start_time + finish_time + day_select,Toast.LENGTH_SHORT).show();*/
        ...
        SaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String dept = prefConfig.readDept().toString();
                String year = prefConfig.readYear().toString();
                ...
                Call<ResponseModel> sendbio = api.DataInsert(subject, teacher, room_no, start_time,
                        finish_time, day_select,dept,year);
                ...
                sendbio.enqueue(new Callback<ResponseModel>() {
                    ...
                    public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                        ...
                        else if(result.equals("Time should not be same...")){
                            Toast.makeText(RoutineDesignActivity.this, "Time can't be Same...",
                                    Toast.LENGTH_SHORT).show();
                        }
                        else {
